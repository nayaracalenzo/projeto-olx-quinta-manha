...
export default function Cadastro() {
  ...
  function handleChangeInputCadastro(event) {
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className=" mt-16 space-y-3">
            <h3 className="text-white text-3xl font-bold">
              Crie anúncios e venda seus produtos fácil e rápido
            </h3>
            <p className="text-gray-300">
              Crie uma conta grátis e tenha acesso livre por 15 dias
            </p>
        ...
        <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
          ...
          <form onSubmit={handleSubmitCadastro} className="space-y-5">
            <div>
              ...
              <input
                onChange={handleChangeInputCadastro}
                type="text"
                name="nome"
                required
